    ...
    <section className="bg-[#0a0a0a] py-24  relative overflow-hidden ">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative ">
        ...
        >
          <Link
            href="/framework"
            className="group relative inline-flex items-center gap-3 px-7 py-3 font-semibold bg-[#ffd000] hover:bg-transparent text-black hover:text-white border-2 border-[#ffd000] overflow-hidden transition-all duration-300"
          >
