          ...
          <div className="absolute bottom-24 left-4 md:left-8 lg:left-12 max-w-[90%] md:max-w-[80%]">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl text-white font-light leading-[1.2] md:leading-[1.3] lg:leading-[1.4]">
                <span className="bg-gradient-to-r from-roar-gold via-roar-orange to-[#ffc800] bg-clip-text text-transparent">
              ...
              >
                ...
                >
                  <Link
                    href="/framework"
                    className="bg-roar-gold hover:bg-transparent text-black hover:text-white border-roar-gold border-2 px-7 py-3 font-semibold inline-flex items-center space-x-2 transition-colors"
                  >
